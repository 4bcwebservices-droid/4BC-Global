...
const lifecycleStages = [
  {
    ...
    services: [
      ...
      { name: 'Partner Identification', desc: 'Identifying and evaluating the right JV partner, distributor, or strategic local partner to enter and operate effectively in the market.' },
    ],
  ...
  },
  {
    ...
    services: [
      ...
      { name: 'Network Planning', desc: 'How can you optimize current formats (e.g. retail formats) while securing a 5-year expansion roadmap that aligns real estate acquisition with future city development and cross-vertical business impact?' },
    ],
